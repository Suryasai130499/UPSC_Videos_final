...
const SubjectPage = ({
  ...
  useEffect(() => {
    ...
    setActiveVideo(Number(lectureNumber - 1));
  }, [activeVideo, setNumber, setSubject, setVideos, subjectName, subjectVideos, setActiveVideo, videos, setInstitute, institute, lectureNumber]);
...
export async function getServerSideProps({ params: { institute, subjectName, number } }) {
